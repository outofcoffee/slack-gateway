...
object SlackOperationsServiceSpec : Spek({
    given("a service") {
        val api = io.gatehill.slackgateway.backend.slack.service.SlackApiService()
        val service = io.gatehill.slackgateway.backend.slack.service.SlackOperationsService(api)
